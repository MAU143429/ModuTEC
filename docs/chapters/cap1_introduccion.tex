...
Asimismo, se entrega el código embebido optimizado para el procesamiento de señales y la gestión de la comunicación serial, complementado con una aplicación en computador personal para la visualización y análisis de las señales generadas, así como la documentación técnica del diseño, implementación y evaluación del sistema desarrollado.
