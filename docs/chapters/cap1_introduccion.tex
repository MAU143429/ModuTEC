...
En este contexto, el proyecto ModuTEC se enmarca en el área del procesamiento digital de señales aplicado a sistemas embebidos, con énfasis en la implementación y evaluación de técnicas de modulación y demodulación en tiempo real. Los trabajos analizados proporcionan fundamentos clave para este desarrollo, al ofrecer referencias sobre arquitecturas de implementación, selección de técnicas de modulación y estrategias de adaptación a hardware embebido. A partir de estos aportes, se busca plantear una solución que equilibre la complejidad algorítmica con la accesibilidad del hardware, incorporando además la capacidad de análisis práctico de señales dentro del mismo entorno embebido.
