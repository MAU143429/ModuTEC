...
\usepackage{pdflscape}                   % allows to have landscape pages in pdf
...
\usepackage{xcolor}
% Definición de colores para circuito
\definecolor{c3v3}{rgb}{0.1,0.3,1}    % Azul para rail 3V3
\definecolor{cgnd}{rgb}{0,0.6,0}       % Verde para GND
\definecolor{csup}{rgb}{0.1,0.3,1}     % Azul para alimentación
